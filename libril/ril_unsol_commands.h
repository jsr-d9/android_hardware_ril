...
*/
    ...
    {RIL_UNSOL_RESPONSE_TETHERED_MODE_STATE_CHANGED, responseInts, WAKE_PARTIAL, J_RIL_UNSOL_RESPONSE_TETHERED_MODE_STATE_CHANGED},
    {RIL_UNSOL_QOS_STATE_CHANGED_IND,   responseStrings, WAKE_PARTIAL, J_RIL_UNSOL_QOS_STATE_CHANGED_IND},
