...
*/
    ...
    {RIL_REQUEST_GET_DATA_CALL_PROFILE, dispatchInts},
    ...
    {0, NULL, NULL, J_RIL_REQUEST_SIM_TRANSMIT_APDU_BASIC},
    {0, NULL, NULL, J_RIL_REQUEST_SIM_OPEN_CHANNEL},
    {0, NULL, NULL, J_RIL_REQUEST_SIM_CLOSE_CHANNEL},
    {0, NULL, NULL, J_RIL_REQUEST_SIM_TRANSMIT_APDU_CHANNEL},
    {RIL_REQUEST_SET_UICC_SUBSCRIPTION, dispatchUiccSubscripton, responseVoid, J_RIL_REQUEST_SET_UICC_SUBSCRIPTION},
    {0, NULL, NULL, J_RIL_REQUEST_GET_DATA_CALL_PROFILE},
    {0, NULL, NULL, J_RIL_REQUEST_GET_CELL_INFO_LIST},
    {0, NULL, NULL, J_RIL_REQUEST_SET_UNSOL_CELL_INFO_LIST_RATE},
    {0, NULL, NULL, J_RIL_REQUEST_SET_INITIAL_ATTACH_APN},
    {0, NULL, NULL, J_RIL_REQUEST_NV_READ_ITEM},
    {0, NULL, NULL, J_RIL_REQUEST_NV_WRITE_ITEM},
    {0, NULL, NULL, J_RIL_REQUEST_NV_WRITE_CDMA_PRL},
    {0, NULL, NULL, J_RIL_REQUEST_NV_RESET_CONFIG},
    {0, NULL, NULL, 0},
    {0, NULL, NULL, 0},
    {0, NULL, NULL, 0},
    {0, NULL, NULL, 0},
