...
static void setUiccSubscription(int request, void *data, size_t datalen __unused, RIL_Token t)
{
...
static void setDataSubscription(int request, void *data, size_t datalen __unused, RIL_Token t)
{
